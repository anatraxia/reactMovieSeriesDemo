...
## Tech Used
The technology used for this solution:
- React
- React-Bootstrap

## Improvement
Future improvement to solution: 
- To implement React Router to route pages
- To use Redux to implement Store
If there are more time for the solution, I will do the following for the solution:
- create react router to allow multi-page to be created
- create store to fetch all the data in JSON link by implementing Redux
- To include description of the movies and series once the thumbnail is being hover on
